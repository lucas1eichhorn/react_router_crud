...
function AgregarProducto({ history, guardarRecargarProductos }) {
    ...
    const agregarProducto = async (e) => {
        ...
        try {
            const resultado = await axios.post("http://localhost:4000/restaurant", { nombrePlatillo, precioPlatillo, categoria })
            console.log(resultado)
            if (resultado.status === 201) {
                Swal.fire({
                    type: 'success',
                    title: 'El producoo se creó correctamente',
        ...
        //seteamos el  state de recargar productos en true. para generar un cambio en el state y que se consulta la api devuelta
